...
const data = [
  ...
  },
  {
    ...
    label: 'menu.customer',
    to: `${adminRoot}/Manage-booking`,
    subs: [
      {
        icon: 'simple-icon-check',
        label: 'menu.managecustomer',
        to: `${adminRoot}/managecustomer`,
      },
  ...
  },
  {
    ...
    label: 'menu.transcation',
    to: `${adminRoot}/Transcation`,
    subs: [
      {
        icon: 'simple-icon-check',
        label: 'menu.managetranscation',
        to: `${adminRoot}/transcation`,
      },
    ]
  },
