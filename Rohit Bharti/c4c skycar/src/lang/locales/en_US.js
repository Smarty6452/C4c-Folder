...
module.exports = {
  ...
  'menu.managebooking': 'Manage Booking',
  'menu.addnewcar': 'Add New Car',
  'menu.managecar': 'Manage Car',
  'menu.managecustomer': 'Manage Customer',
  'menu.customer': 'Customer',
  'menu.car': 'Cars',
  'menu.adcar': 'add new car',
  'menu.booking': 'Booking',
  'menu.transcation': 'Transcation',
  'menu.managetranscation': 'Manage Transcation',
  ...
  'dashboards.totalcar': 'Total Cars',
  'dashboards.booking': 'Booking',
  'dashboards.customer': 'Customer',
  'dashboards.transcation': 'Transcation',
  ...
  'forms.name': 'Name',
  'forms.carname': 'Car Name',
  'forms.brand': 'Brand',
  'forms.modal': 'Modal',
  'forms.Type': 'Type',
  'forms.Seatingcapacity': 'Seating Capacity',
  'forms.plateno': 'Plate Number',
  'forms.fueltype': 'Fuel Type',
  'forms.fuelcapacity': 'Fuel Capacity',
  'forms.year': 'Year Of Manufacturing',
  'forms.colour': 'Colour',
  'forms.hcharge': 'Hourly Charge',
  'forms.dcharge': 'Daily Charge',
  'forms.wcharge': 'Weakly Charge',
  'forms.mcharge': 'Monthly Charge',
  'forms.icharge': 'Insurance Charge Per day',
  'forms.frtails': 'Details',
  'forms.branch': 'Branch',
  'forms.front-view-upload': 'Front View Image',
  'forms.rear-view-upload': 'Rear View Image',
  'forms.left-side-view-upload': 'Left Side View Image',
  'forms.right-view-upload': 'Right View Image',
  'forms.interior-view-upload': 'Interior View Image',
